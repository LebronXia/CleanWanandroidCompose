...
import com.riane.ui.component.CircleLoading
...
private fun LazyListScope.pagingLoadMore(pagingItems: LazyPagingItems<out Any>) {
    when {
        ...
        pagingItems.loadState.append == LoadState.NotLoading(true) -> {
            ...
            item {
                Box(
                    ...
                    Text(text = "没有数据了",  color = Color.Black)
                }
            }
        }
