...
//                            while (true) {
//                                //PointerEventPass.Initial - 本控件优先处理手势，处理后再交
...
//                                        //当页面没有任何滚动/动画的时候pagerState.targetPag
//                                        if (pagerState.targetPage == null) return@awaitPointerEventScope
//                                        //当pageCount大于1，且手指抬起时如果页面没有改变，
...
//            modifier = Modifier.fillMaxSize().clip(shape = rl), RoundedCornerShape(16.dp)),
//                    contentScale = ContentScale.Crop,
//                contentDescription = null
//            )
//    }
...
//                    //颜色
//                    val color =
//                        if (pagerState.currentPage == i) MaterialTheme.colors.primary e
//
//                                Box(
//                                    modifier = Modifier
//                                        .clip(CircleShape)
